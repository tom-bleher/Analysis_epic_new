...
class HandleEIC(object):
    ...
    def init_path(self) -> None:
        ...
        print(os.listdir("/data/tomble/Analysis_epic_new/simulations/genEvents/results"))
        self.energy_levels  = [file for file in sorted(os.listdir("/data/tomble/Analysis_epic_new/simulations/genEvents/results")) if self.file_type in file]  
    ...
    def prepare_files(self, curr_px_dx: float, curr_px_dy: float) -> None: 
       ...
       # execute those simulations
        self.exec_simv3(curr_run_queue)
    ...
    def setup_queue(self, curr_epic_ip6_path, curr_pix_path: str) -> dict:
        ...
        for file in self.energy_levels : 
            inFile = os.path.join(self.genEvents_path,"/results/",file)
